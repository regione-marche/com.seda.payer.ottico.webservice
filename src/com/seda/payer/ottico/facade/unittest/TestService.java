...
public class TestService {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("TEST: Risultato esito recuperaListDoc " + respDoc.getReqresp().getRetCode() + respDoc.getReqresp().getRetMessage());
			...
			if (respDoc != null) {
				...
				FileWriter fstream = new FileWriter("LISTA_DOC.xml");
				...
				DocumentoType[] doc_Lst = new DocumentoType[ecCached_ListaDoc.size()];
...
//								pagamentoInAcquisizione);
				...
				System.out.println("La lista documentyi ha "+ doc_Lst.length + " elementi.");
				System.out.println("\n\n\n-------------------------------------\nDettaglio Documento\n");
...
//							BigDecimal.valueOf(nf.parse(ecCached_Scadenze.getString(4)).doubleValue()),
//							BigDecimal.valueOf(nf.parse(ecCached_Scadenze.getString(5)).doubleValue()),
//							BigDecimal.valueOf(nf.parse(ecCached_Scadenze.getString(6)).doubleValue()),
//							BigDecimal.valueOf(nf.parse(ecCached_Scadenze.getString(7)).doubleValue()),
//							BigDecimal.valueOf(nf.parse(ecCached_Scadenze.getString(8)).doubleValue()),
//							BigDecimal.valueOf(nf.parse(ecCached_Scadenze.getString(9)).doubleValue()),
